    ...
    <footer className={styles.footer}>
      <div className={styles.content}>
        <div className={styles.left}>
          <p className={styles.name}>Nicolás Saporiti</p>
          <p className={styles.tagline}>Notas sobre tecnología, programación y Bitcoin.</p>
        ...
        <div className={styles.right}>
          ...
          <a href="https://payments.saporiti.cl/" target="_blank" rel="noopener noreferrer">Donar Sats</a>
        </div>
      </div>
      <div className={styles.bottom}>
        <p>&copy; {new Date().getFullYear()} Nicolás Saporiti. Todos los derechos reservados.</p>
      </div>
    </footer>
  );
}
